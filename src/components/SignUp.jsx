    ...
    <div className="flex flex-col justify-center items-center h-screen">
      <div className="p-5 shadow-lg rounded-lg">
        <div className="flex flex-col justify-center items-center pb-10">
          ...
          <p className="text-center text-[0.75rem] font-MontserratRegular text-[#333]">Join more than <span className="font-bold">25,000</span> users that trust SproutySocial to grow on Instagram. Create an account.</p>
        </div>
