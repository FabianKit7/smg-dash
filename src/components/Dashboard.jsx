...
const Starts = () => {
  return (<>
    <div className="mt-4 lg:mt-0 flex justify-between items-center gap-1 lg:gap-4 w-screen text-center px-4">
      <div
        className="bg-[#1b89ff] text-white md:w-[220px] cursor-pointer rounded-[10px] flex flex-col justify-center itext-center p-2 lg:pt-3 lg:pr-4 lg:pb-[2px] lg:pl-5"
        style={{
          transition: 'all .15s ease-in',
        }}
      >
        <div className="text-[12px] lg:text-[16px] font-[500]">Followers</div>
        <div className="flex flex-col lg:flex-row justify-between items-center">
          <div className="text-[24px] lg:text-4xl lg:leading-[54px] font-MontserratBold font-bold">
            49.6k
          </div>
          <div className="absolute lg:static top-[calc(100%-20px)] left-[50%] translate-x-[-50%] py-1 px-2 rounded-[7px] bg-[#c8f7e1] text-[#23df85] mt-1 flex items-center gap-1 text-[10px] lg:text-[12px] font-bold font-MontserratBold">
      ...
      <div
        className="text-black md:w-[220px] cursor-pointer rounded-[10px] flex flex-col justify-center itext-center p-2 lg:pt-3 lg:pr-4 lg:pb-[2px] lg:pl-5 lg:shadow-[0_0_3px_#00000040]"
        style={{
          transition: 'all .15s ease-in',
        }}
      >
        <div className="text-[12px] lg:text-[16px] font-[500] text-[#757575]">
          Followings
        </div>
        <div className="text-[24px] lg:text-4xl lg:leading-[54px] font-MontserratBold font-bold">
          300
...
const AddOthers = ({ pageProp, userId, addSuccess, setAddSuccess }) => {
  ...
  return (<>
    <div key={pageProp.id} className="w-[430px] mt-8 lg:mt-[50px] pl-4 h-[380px] relative">
      <div
    ...
    <div>
      ...
      <div className="lg:m-10 mt-0 flex flex-col lg:flex-row items-center">
        <div className="grow w-full lg:w-auto">
          ...
          <div className="max-h-[380px] lg:h-[380px] overflow-y-auto flex flex-col gap-[11px] pr-4">
